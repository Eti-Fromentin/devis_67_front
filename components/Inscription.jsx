...
function Inscription() {
  const validationSchema = Yup.object().shape({
    ...
    username: Yup.string().required('⚠ Le nom utilisateur est requis').min(6, '⚠ Minimum de 6 caractères').max(20, '⚠ Maximum de 20 caractères'),
    ...
    password: Yup.string().required('⚠ Mot de passe requis').min(6, '⚠ Minimum de 6 caractères').max(40, '⚠ Maximum de 40 caractères'),
              ...
              <Card.Body>
                <Form onSubmit={handleSubmit(formSubmit)}>
                  ...
                  <Form.Group className="mb-3" controlId="nickname">
                    <Form.Label>Nom d&#39 utilisateur*</Form.Label>
